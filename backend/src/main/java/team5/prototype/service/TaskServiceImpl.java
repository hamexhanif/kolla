...
import team5.prototype.service.PriorityService;
...
public class TaskServiceImpl implements TaskService {
    ...
    public Task createTaskFromDefinition(TaskCreationRequest request) {
        WorkflowDefinition definition = definitionRepository.findById(request.workflowDefinitionId())
                .orElseThrow(() -> new EntityNotFoundException("WorkflowDefinition %d nicht gefunden".formatted(request.workflowDefinitionId())));
